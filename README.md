...
<h1 align="center">  Sprint 3: 08/05/2023 a 07/06/2023 </h1>
...
- :heavy_check_mark: **RF 10:** Sprint Backlog;
...
Este requisito trata da elaboração de um plano de ação básico a ser desenvolvido para a elaboração do projeto final.

- 🧷 **RF 11:** Dailys

Este requisito trata das reuniões diárias entre todos os membros da equipe para acompanhamento, avaliação e redefinição (quando necessário) das  ações. Durante as dailys pudemos redefinir algumas práticas e melhorar a comunicação e troca de ideias entre a equipe.  

- 🧷 **RF 12:** Retrospective


Este requisito trata do momento em que o time se dedica a inspecionar seu trabalho, avaliando como foi a última Sprint e criando um plano de ação para a próxima. Esta avaliação e planejamento foi realizado logo ao término da Sprint anterior.


- 🧷 **RF 13:** DOR – Definition of Ready


Este requisito trata do conjunto de “combinados” entre o Scrum Team que cada item de backlog que vai para a Sprint Planning deve atender. Os itens de backlog que atendam a DOR são itens Ready. São importantes para garantir que os itens do backlog estejam prontos para serem trabalhados na Sprint e para evitar que o time perca tempo durante a Sprint Planning discutindo itens que não estão prontos.


- 🧷 **RF 14:** DOD -Definition of Done

Este requisito trata o da criação e conferência de uma espécie de checklist que deve ser cumprida para que o item do backlog esteja, de fato, pronto.


- 🧷 **RF 15:** Planning Poker

Este requisito trata da aplicação de um jogo para distribuição das tarefas e avaliação do tempo a ser gasto. Infelizmente tomamos ciência do que se tratava a proposta somente neste sprint, não tendo sido realizado nos sprints anteriores.

- 🧷 **RF 16:** Kanban

Este requisito trata da estrutura de gestão de projetos para o gerenciamento do fluxo de trabalho. Foi aplicado na planilha de projetos do GitHub e através de planilha Excel.


- 🧷 **RF 17:** Artefatos do Scrum

Este requisito trata dos três artefatos do Scrum: backlog do produto, backlog do sprint e o incremento que conforme pode ser observado nos itens anteriores foram concluídos.


- 🧷 **RF 18:** MVP (Minimum Viable Product – ou Produto Mínimo Viável)

Este requisito trata da construção da versão mais simples e enxuta do produto final, que foi apresentada no início do projeto.
...
Este requisito trata do uso da linguagem JavaScript em trechos do desenvolvimento da página do site, para interação com o cliente.
...
- 🧷 **RNF 04:** Uso do framework Bootstrap


Este requisito trata da utilização dos recursos do framework Bootstrap para facilitar a inserção de elementos como botões, e outros, no desenvolvimento das páginas.


Por fim, no desenvolvimento do projeto, foram utilizados até o momento as tecnologias: JavaScript; HTML, CSS, Bootstrap e Figma. Para a criação dos módulos, exercícios de fixação e certificado, utilizamos também os aplicativos Canva, WordWall e YouTube.
...
Concordamos que o resultado foi muito positivo: o desafio foi grande e exigiu muita dedicação e pesquisa de todos. Cada membro da equipe participou e comprometeu-se com o projeto, em sistema de autogerenciamento. Houve a melhoria da comunicação, contudo este item continua sendo um desafio entre os membros da equipe, e deverá ser melhor discutido e corrigido no decorrer dos próximos trabalhos do curso. Para a nossa comunicação, além das Dailys, fizemos uso do GitHub e criamos um grupo no Teams e WhatsApp. Quanto ao autogerenciamento, sentimos que tarefas fluíram com assertividade e rapidez. A aplicação do framework Scrum foi muito satisfatória. Todas as decisões para o desenvolvimento do projeto foram compartilhadas, discutidas e aprovadas por toda equipe.
